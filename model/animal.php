...
class Animal extends Crud
{
  ...
  public function create(){
    try {
      ...
      $stm->execute([$this->name,$this->specie,$this->breed,$this->gender,$this->color,$this->age]);
  ...
  public function update(){
    try {
      ...
      $stm->execute([$this->name,$this->specie,$this->breed,$this->gender,$this->color,$this->age,$this->id]);
    } catch (\Exception $e) {
        echo $e->getMessage();
    }
  }
